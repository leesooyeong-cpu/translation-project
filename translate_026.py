...
PPT_FILES = [
    "TSCS-G026-0003_A1_20250218_DÂY SHIELD_Danh sách kiểm tra hàng ngày ( sản xuất ).ppt",
]
...
def main():
    src_dir = Path(r"C:\hex_edit_project\VN_original\026_Tiêu chuẩn_Công đoạn_Dây Sheild")
