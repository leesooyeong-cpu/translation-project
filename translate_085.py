...
def main():
    src_dir = Path(r"C:\hex_edit_project\VN_original\085_Tiêu chuẩn_Công đoạn_Thử điện áp trong")
    out_dir = Path(r"C:\베트남 티에스텍 업무\13. 절압팀\절차서 TC\085 표준_공정_내전압 시험 작업")
